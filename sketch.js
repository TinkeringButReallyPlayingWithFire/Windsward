...
function setup() {
  ...
  gridGraphing.position(1640, 949);
  ...
  gridHandwriting.position(1540, 949);
  ...
  gridMathematics.position(1354.5, 949);
...
setInterval(function () {
  ...
  $('head').append(
    '<link rel="icon" href="' +
      gifTitleIcon_images[image_counter] +
      '" type="image/gif">',
  );
